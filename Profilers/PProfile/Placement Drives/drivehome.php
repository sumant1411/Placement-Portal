          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="../../../Homepage/index.php">NMIMS</a></li>
...
$prev = $currentpage-1;
 ...
 ?> 
          ...
          <footer class="text-right">
           		<p>Copyright &copy; 2023 NMIMS | Developed by Raj Patil
              <a href="http://PlaceemntPortal.net" target="_parent">PLacementPortal</a>
			  </p>
          </footer>         
        </div>
      </div>
