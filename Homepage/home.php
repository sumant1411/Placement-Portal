        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.Placementportal.in">Placement Portal</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>+917738804129</p>
					<a href="mailto:sumantrawat14@gmail.com">support@placements</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Raj Patil&copy; 2023 | Developed by
              <a href="http://placementportal.in" target="_parent">Raj Patil</a>
				</div>
