      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
			...
			<centre><h2 class="margin-bottom-10">Read Message</h2>
            <p>Notifications from Placement Department and Principal</p></centre>
            
              
          </div>
          <footer class="text-right">
            <p>Copyright &copy; 2023 Placement Portal
            | Developed by <a href="http://RajPatil.com" target="_parent">Raj Patil</a></p>
          </footer>
        </div>
      </div>
    </div>
