...
<html lang="en">
 ...
 <centre><h2>Approved Students List of CIVIL</h2></centre>
...
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='CIVIL' LIMIT $start_from, $num_rec_per_page"; 
...
mysql_connect('localhost','root','');
mysql_select_db('placement');
$sql = "SELECT * FROM basicdetails where Approve='1' and Branch='CIVIL'"; 
$rs_result = mysql_query($sql); //run the query
